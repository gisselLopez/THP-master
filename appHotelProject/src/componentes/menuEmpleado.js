...
//ModificarCuentaE significa que va modificar la cuenta del empleado
  return (
    <View style={styles.container}>
        <View style={styles.btnLayout} >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('DashboardFactura') }
            >
            <Image 
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('ModificarCuentaE')}
            >
             <Image 
           ...
           <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('ListaEmpleado')}>
            <Text style={styles.buttonText}>Listar empleados</Text>
          </TouchableOpacity>
