...
import AsyncStorage from '@react-native-async-storage/async-storage';
  ...
  export default function DashboardHabitacion({navigation}) {
    ...
    <View style={styles.container}>
        <View style={styles.btnLayout} >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('GuardarHabitacion') }
            >
            <Image 
              source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Crear habitacion</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
            ...
            source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Habitaciones</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity 
            ...
            source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Listado Servicios Habitacion</Text>
          </TouchableOpacity>
