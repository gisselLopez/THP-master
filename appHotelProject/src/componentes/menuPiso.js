...
import AsyncStorage from '@react-native-async-storage/async-storage';
  ...
  export default function DashboardPiso({navigation}) {
    ...
    <View style={styles.container}>
        <View style={styles.btnLayout} >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('GuardarPiso') }
            >
            <Image 
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('ListarPisos')}
            >
            <Image 
            source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Modificar Piso</Text>
          </TouchableOpacity>
