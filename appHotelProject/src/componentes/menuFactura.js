...
//const tab = createBottomTabNavigator();
  export default function DashboardFactura({navigation}) {
    useEffect(() => {
    ...
    <View style={styles.container}>
        <View style={styles.btnLayout} >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('GuardarFactura') }
            >
            <Image 
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('ListarFacturas')}
            >
            <Image 
            source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Listar Facturas</Text>
          </TouchableOpacity>
