...
import AsyncStorage from '@react-native-async-storage/async-storage';
  ...
  export default function DashboardTipoPago({navigation}) {
    ...
    <View style={styles.container}>
        <View style={styles.btnLayout} >
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('GuardarTipoPago') }
            >
            <Image 
              source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Crear Tipo Pago</Text>
          </TouchableOpacity>

          <TouchableOpacity 
            style={[styles.buttonContainer, { backgroundColor: '#0ae299'}]}
            onPress={() => navigation.navigate('ListarTipoPago')}
            >
            <Image 
            source={require('../iconos/Piso2.png')}
              style={styles.buttonIcon}
            />
            <Text style={styles.buttonText}>Listar Tipo Pago</Text>
          </TouchableOpacity>
