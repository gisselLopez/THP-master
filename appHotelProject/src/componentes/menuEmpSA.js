...
export default function DashboardEmpleadoAdmin({navigation}) {
  useEffect(() => {
...
const subjects = [
  ...
  {id:9, name:'Empleado', nav: 'DashboarEmpleadoSA'   ,color:'#6eccfc' ,  img:'https://cdn-icons-png.flaticon.com/512/912/912318.png'}
];
